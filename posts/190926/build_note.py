...
body.night-mode,
body.night-mode .note-layout,
body.night-mode .jp-Notebook {
  background: #1e1e1e !important;
}

body.night-mode .jp-RenderedHTMLCommon,
body.night-mode .jp-RenderedHTMLCommon p,
body.night-mode .jp-RenderedHTMLCommon li,
body.night-mode .jp-RenderedHTMLCommon td,
body.night-mode .jp-RenderedHTMLCommon th {
  color: #d4d4d4 !important;
}

body.night-mode .jp-RenderedHTMLCommon h1,
body.night-mode .jp-RenderedHTMLCommon h2,
body.night-mode .jp-RenderedHTMLCommon h3,
body.night-mode .jp-RenderedHTMLCommon h4 {
  color: #f0f0f0 !important;
}

body.night-mode .jp-RenderedHTMLCommon a {
  color: #78b7ff !important;
}

body.night-mode .jp-RenderedHTMLCommon blockquote {
  color: #bdbdbd !important;
  border-left-color: #555555 !important;
}

body.night-mode .jp-RenderedHTMLCommon pre,
body.night-mode .jp-RenderedHTMLCommon code {
...
body.night-mode {
  ...
  --jp-layout-color2: #252525 !important;
  --jp-cell-editor-background: #252525 !important;
  --jp-notebook-selectors-color: #d4d4d4 !important;
  --jp-border-color0: #444444 !important;
  --jp-border-color1: #444444 !important;
  --jp-border-color2: #444444 !important;
...
body.night-mode .jp-RenderedHTMLCommon table {
  color: #d4d4d4 !important;
}
...
body.night-mode .note-toc-title {
  color: #f0f0f0 !important;
}

body.night-mode .note-toc a {
  color: #999999 !important;
}

body.night-mode .note-toc a:hover,
body.night-mode .note-toc a.active {
  color: #ffffff !important;
}
...
<nav class="site-nav">
  <div class="nav-inner">
    ...
    <button class="theme-toggle" id="theme-toggle" type="button" aria-label="Toggle night mode"></button>
  </div>
</nav>
